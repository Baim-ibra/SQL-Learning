...
\copy job_postings_fact FROM 'C:\Users\CICI SRIMELATI\Documents\LB\SQL Learning\csv_files\job_postings_fact.csv' WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

\copy skills_job_dim FROM 'C:\Users\CICI SRIMELATI\Documents\LB\SQL Learning\csv_files\skills_job_dim.csv' WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');
